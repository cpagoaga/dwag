...
class UNCDWF_Init {
	...
	public function __construct() {
		...
		// Add wireframes
		add_action( 'vc_load_default_templates_action', array( $this, 'add_wireframes' ) );
		...
		add_action( 'uncode_render_backend_template', array( $this, 'initialize_dynamic_class' ) );
	 ...
	 */
	public function add_wireframes() {
		global $post;
	...
	/**
	 * Initialize dynamic class when a template is loaded via AJAX
	 */
	public function initialize_dynamic_class() {
