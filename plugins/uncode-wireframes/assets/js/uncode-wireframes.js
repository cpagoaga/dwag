jQuery(document).ready(function ($) {
	...
	if (addElementButton.length > 0) {
		addElementButton.parent().append('<div class="vc_add-element-wrap"><a id="vc_not-empty-add-wireframe" class="vc_add-element-not-empty-button" ><i class="fa fa-layout"></i><span>' + WireframeParameters.locale.add_wireframe + '</span></a></div>');
		addElementButton.wrap('<div class="vc_add-element-wrap"></div>');
